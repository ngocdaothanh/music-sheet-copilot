                ...
                VStack(spacing: 20) {
                    ...
                    HStack(spacing: 15) {
                        Menu {
                            ...
                            Button("Finger Exercise 3") {
                                loadDemoFile(named: "fingure_excercise3")
                            }
                            Button("Finger Exercise 4") {
                                loadDemoFile(named: "fingure_excercise4")
                            }
                            Button("Finger Exercise 5") {
                                loadDemoFile(named: "fingure_excercise5")
                            }
                            Button("Finger Exercise 6") {
                                loadDemoFile(named: "fingure_excercise6")
                            }
                            Button("Finger Exercise 7") {
                                loadDemoFile(named: "fingure_excercise7")
                            }
                            Button("Finger Exercise 8") {
                                loadDemoFile(named: "fingure_excercise8")
                            }
